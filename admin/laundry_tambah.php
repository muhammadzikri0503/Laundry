		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<select name="jadwal_selesai" id="jadwal_selesai" class="form-control" required="">
					...
					<option value="Sehari">Sehari <i>(+ Harga Rp. 6.000)</i></option>
					<option value="Dua Hari">Dua Hari <i>(+ Harga Rp. 5.000)</i></option>
					<option value="Tiga Hari">Tiga Hari <i>(+ Harga Rp. 4.000)</i></option>
					<option value="Empat Hari">Empat Hari <i>(+ Harga Rp. 3.000)</i></option>
					<option value="Lima Hari">Lima Hari <i>(+ Harga Rp. 2.000)</i></option>
					<option value="Enam Hari">Enam Hari <i>(+ Harga Rp. 1.000)</i></option>
					<option value="Tujuh Hari">Tujuh Hari</option>
				</select>
			</div>
		</div>
		<div class="col-md-6">
...
<?php 
	if (isset($_POST['tambah'])) {
		...
		if ($jadwal_selesai == "Sehari") {
			...
			$tambah = "4000";
		}elseif ($jadwal_selesai == "Empat Hari") {
			$tambah = "3000";
		}elseif ($jadwal_selesai = "Lima Hari") {
			$tambah = "2000";
		}elseif ($jadwal_selesai = "Enam Hari") {
			$tambah = "1000";
		}elseif ($jadwal_selesai = "Tujuh Hari") {
			$tambah = "0";
		}
