...
<body id="page-top">
    ...
    <div id="content-wrapper">
      <div class="container-fluid">
        <?php 
          ...
          elseif (@$_GET['p'] == "petugas_tambah") {
            include_once'petugas_tambah.php';
          }
          elseif (@$_GET['p'] == "petugas_edit") {
            include_once'petugas_edit.php';
          }
          elseif (@$_GET['p'] == "petugas_hapus") {
            include_once'petugas_hapus.php';
          }
          elseif (@$_GET['p'] == "paket") {
  ...
  <script>
    $(document).on('click', '#cetak', function(){
      ...
      window.open('cetak_laporan.php?tgl_awal='+tgl_awal+"&tgl_akhir="+tgl_akhir, '_blank');
    });
  </script>
</body>
</html>
